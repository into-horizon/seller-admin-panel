...
const routes = [
  ...
  { path: '/product/add', name: 'add Product', component: AddProduct , approved: true },
  { path: '/product/products', name: 'my Products', component: Products , approved: true},
  { path: '/product/updateProduct', name: 'update Product', component: UpdateProduct , role: 'storeOwner', approved: true},
