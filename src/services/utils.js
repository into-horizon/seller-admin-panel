...
export const getSearchParamsObject = (searchParams) => {
  let data = {}
  searchParams.forEach((value, key) => !_.isEmpty(value) && (data[key] = value))
  return data
}

export const updateSearchParams = (key, value, searchParams, setSearchParams) => {
  let data = {}
...
export const updateParamsHelper = ({ limit }, currentPage) => {
  return { offset: limit * (currentPage - 1), limit }
}
