...
export const divideCategories = (products, categories) => {
   
    let array = categories.categories[0].values.response.subcategory
    let filteredCategories = [];
    array.forEach((category, i) =>{
        let val = products.filter(val => val.categoryId === category.uuid)
